...
<div class="bg-gray-900 min-h-screen flex-grow min-w-full text-white p-5 flex flex-col">
	<div class="flex flex-col place-items-center m-auto gap-y-4 my-auto">
		...
		<button type="button" on:click|preventDefault={loginOverride} class="flex flex-row gap-x-2 p-2 bg-black text-lg font-semibold place-items-center border-2 rounded-lg">
